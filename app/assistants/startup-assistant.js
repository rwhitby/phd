function StartupAssistant(changelog)
{
    ...
    this.firstMessage = $L('The official source for information about Preware, WebOS Internals and great Homebrew Applications.<br><br>Rod Whitby (the founder/lead of WebOS Internals, and architect of the Preware webOS homebrew ecosystem) has gathered together an extensive collection of official documentation about the Preware Homebrew Installer and other Homebrew Applications, Patches, Themes and Custom Kernels.');
	...
	[
	 ...
	 { version: '3.0.0', log: [ 'Packaged both Mojo and Enyo versions in a multi-platform package',
				    'Added more information regarding recent overclocking kernel advances',
				    'Added a note about configurable patches and the Tweaks application' ] },
